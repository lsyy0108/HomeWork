...
public class FacultyIntroduction2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FacultyIntroduction2 frame = new FacultyIntroduction2();
	...
	public FacultyIntroduction2() {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/images/teacher2.jpg"));
