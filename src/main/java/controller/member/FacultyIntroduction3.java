...
public class FacultyIntroduction3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FacultyIntroduction3 frame = new FacultyIntroduction3();
	...
	public FacultyIntroduction3() {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/images/teacher3.jpg"));
